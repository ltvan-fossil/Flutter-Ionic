  ...
  function proxyModuleExports(module) {
    ...
    const handler = {
      ...
      getOwnPropertyDescriptor: (t, p) =>
        Reflect.getOwnPropertyDescriptor(module.exports, p),
...
__d(
  function (
    ...
    const statusMap = {
      ...
      Moderate:
        "There may be a moderate health concern for people being sensitive to air pollution.",
      Sensitive:
        "Childrent and people with respiratory disease may experience health effects.",
      Unhealthy: "Everyone experience health effects.",
      "Very Unhealthy":
        "Health warnings of emergency conditions. The entire population is affected.",
      Hazardous:
    ...
    LiquidCore.on("response", function (payload) {
      ...
      if (reqType == "one_time_gps_data") {
        ...
        axios
          .get(
            `https://api.airvisual.com/v2/nearest_city?key=ce2d6b01-2c31-457a-b3f3-80fb400d8901&lat=${payload.lat}&lon=${payload.long}`
          )
...
__d(
  ...
  23,
  [3, 14, 17, 6, 24, 25, 26, 27, 40, 41, 15, 16]
);
__d(
  function (
    global,
...
__d(
  function (global, require, _aUnused, _bUnused, module, exports, _cUnused) {
    module.exports = {
      _from: "axios",
      _id: "axios@0.19.2",
      _inBundle: false,
      ...
      _spec: "axios",
      _where:
        "/Users/tthieu/Documents/001_Work/001_Repo/fossil-ble-sdk-android_01",
      author: {
        name: "Matt Zabriskie",
      },
      browser: {
